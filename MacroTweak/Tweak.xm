...
// Interface declaration for UIWindow to declare new methods
// This fixes the "no visible @interface" compiler errors
@interface UIWindow (MacroTweak)
...
- (void)loadSavedMacro {
    ...
    if ([[NSFileManager defaultManager] fileExistsAtPath:path]) {
        ...
        for (NSDictionary *dict in saveData) {
            ...
            event.phase = (UITouchPhase)[dict[@"phase"] integerValue];  // Cast to fix type error
